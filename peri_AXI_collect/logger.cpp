...
Logger::Logger(const std::string& csv_path) : ofs_(csv_path) {
    ...
    ofs_ << "index,timestamp,mode,event,id,command_name,image_path,"
         ...
         << "stick1,stick3,"
         << "raw0,raw1,raw2,raw3,"
         << "raw12_0,raw12_1,raw12_2,raw12_3,"
...
void Logger::log_action(int index,
    ...
    write_common(index, timestamp, mode, "action", image_path, cmd, raw, raw12, diff, aruco);
}
...
void Logger::log_goal(int index,
    ...
    write_common(index, timestamp, mode, "goal", image_path, cmd, raw, raw12, diff, aruco);
}
