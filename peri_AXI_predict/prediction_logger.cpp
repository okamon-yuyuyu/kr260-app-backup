...
PredictionLogger::PredictionLogger(
    ...
    ofs_ << "index,timestamp,image_path,model_type,predicted_label,predicted_command,"
            "confidence,inference_ms,status,command_sent,current_posture,start_battery_voltage_v";
